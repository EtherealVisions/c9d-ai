    ...
    <div className="flex flex-col min-h-screen bg-c9n-blue-dark text-gray-200">
      ...
      <main className="flex-grow">
        ...
        <FeatureHighlightSection
          title="Explore the C9N.AI Insight Engine"
          ...
          imageAlt="C9N.AI Insight Engine visualization"
          reverseLayout={false}
        />

        <FeatureHighlightSection
          title="Rapid Correlation. Instant Reports."
          description="A single query, limitless insights, complete clarity. The full power of C9N.AI's rapid analysis is exclusive to our platform, delivering actionable intelligence in seconds."
