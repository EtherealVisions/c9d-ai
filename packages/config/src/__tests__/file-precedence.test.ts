...
describe('File Precedence Testing', () => {
  ...
  describe('Complex precedence scenarios', () => {
    it('should handle multiple variables with different precedence sources', async () => {
    ...
    it.skip('should handle basic variable expansion', async () => {
  ...
  describe('Environment-specific precedence', () => {
    ...
    for (const env of environments) {
      it(`should load ${env} environment variables correctly`, async () => {
  ...
  describe('Phase.dev token precedence', () => {
    it('should access real Phase.dev token from environment', async () => {
